...
% Added the "person_noun" input variable so that the question about
% which device to use can be phrased correctly
%
% 2012.02.29
% Modification by Edward Lau <eplau[at]ucla[dot]edu>
% Adddeed "chosen_device_name" output variable to describe the chosen
% input device.
